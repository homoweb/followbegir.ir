...
import type { Option, Product } from '@/types/followbegir';
...
const form = useForm({
    ...
    step_quantity: props.product.step_quantity,
    base_price: props.product.base_price,
    prices: (props.product.prices ?? []).map((tier) => ({ ...tier })),
...
const submit = (): void => {
    form.put(adminProducts.update.url(props.product));
};
</script>
